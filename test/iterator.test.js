...
describe('resolve ode system of two functions between a range', () => {
  ...
  test('should get Lotka Volterra', () => {
    ...
    console.log(solution[4000][1])
    console.log(solution[4000][2])
    expect(solution[4000][1]).toBeCloseTo(integrator.y[0], 10)
    expect(solution[4000][2]).toBeCloseTo(integrator.y[1], 10)
  })
